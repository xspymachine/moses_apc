...
public class UploadSignatureActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.upsignature);
        context = UploadSignatureActivity.this;
        try {
	       ...
	       fileList(currentPath);        
        	...
        	Toast.makeText(getApplicationContext(), "ERROR On Create... " +  Environment.getExternalStorageDirectory() + "/"
      	            + getResources().getString(R.string.signatures_dir) + "/" , Toast.LENGTH_LONG ).show();
        }
    }
  ...
  //sorts based on the files name 
    ...
    public void uploadButtonClicked(View button) {
    	if (isConnected()) {
	    	...
	    	Toast.makeText(getApplicationContext(), "Uploading Signature... "  , Toast.LENGTH_LONG ).show();
	    	...
	    	if (!selected) Toast.makeText( getApplicationContext(), "Select a file or files to upload..."  , Toast.LENGTH_SHORT ).show();
	    		...
	    		SignatureUploader mFileUploader = new SignatureUploader(selectedFiles);
    ...
    //**** Multi-File Uploader
    //********************************************************
    public class SignatureUploader extends AsyncTask<String, String, ArrayList<String>> {
    	private HashMap<String, String> mData = null;// post data
    	
    	
    	private ArrayList<String> Responses;
    	
    	public SignatureUploader(HashMap<String, String> data) {
            mData = data; 
        }     		
