...
public class FontsOverrideApplication extends Application {
    ...
    private static final String DEFAULT_NORMAL_BOLD_FONT_FILENAME = "AvenirLTStd-Bold.otf";
    private static final String DEFAULT_NORMAL_BOLD_ITALIC_FONT_FILENAME = "AvenirLTStd-BoldItalic.otf";
    private static final String DEFAULT_NORMAL_ITALIC_FONT_FILENAME = "AvenirLTStd-Italic.otf";
    private static final String DEFAULT_NORMAL_NORMAL_FONT_FILENAME = "AvenirLTStd-Regular.otf";
...
//                FirebaseCrash.log(getResources().getString(R.string.versiondate));
//                FirebaseCrash.report(throwable);
////                System.exit(2);
//            }
//        });
//
//        FirebaseMessaging.getInstance().subscribeToTopic("xplus");
