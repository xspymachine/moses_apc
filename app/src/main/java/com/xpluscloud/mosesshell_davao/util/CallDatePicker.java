...
import com.xpluscloud.mosesshell_davao.CustomerCallSummary.DateDialogFragmentListener;

import java.util.Calendar;

public class CallDatePicker extends DialogFragment {
	...
	public static CallDatePicker newInstance(Context context, DateDialogFragmentListener listener, Calendar now) {
		CallDatePicker dialog = new CallDatePicker();
		mContext = context;
		mListener = listener;
