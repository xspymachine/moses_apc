...
import com.xpluscloud.mosesshell_davao.CustomerDataActivity.DateDialogFragmentListener;

public class CustomerDatePicker extends DialogFragment {
	...
	public static CustomerDatePicker newInstance(Context context, DateDialogFragmentListener listener, Calendar now) {
		CustomerDatePicker dialog = new CustomerDatePicker();
		mContext = context;
		mListener = listener;
