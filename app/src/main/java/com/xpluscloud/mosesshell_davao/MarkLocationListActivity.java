...
public class MarkLocationListActivity extends ListActivity {
	final String TAG = "MarkLocationListActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = MarkLocationListActivity.this;
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence arg0, int arg1,
                                      int arg2, int arg3) {
				MarkLocationListActivity.this.adapter.getFilter().filter(arg0); 				
			}         
	...
	public void initListView() {		
		MarkedLocationDbManager db = new MarkedLocationDbManager(this);
		db.open();		
