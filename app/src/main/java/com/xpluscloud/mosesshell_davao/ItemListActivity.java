...
public class ItemListActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                ItemListActivity.this.adapter.getFilter().filter(inputSearch.getText().toString());   
            }
	...
	private static class ItemListAdapter extends BaseAdapter implements Filterable {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.prices.setText(Master.PRICE_PER_PACK +": "
					+ filteredList.get(position).getPricePerPack() + " \n" 
				+ Master.PRICE_PER_UNIT + ": " 
					+ filteredList.get(position).getPricePerUnit());
